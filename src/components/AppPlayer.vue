...
import usePlyerStore from '@/stores/player';

export default {
  name: 'AppPlayer',
  computed: {
    ...mapState(usePlyerStore, ['playing', 'duration', 'seek', 'playerProgress', 'currentSong'])
  },
  methods: {
    ...mapActions(usePlyerStore, ['toggleAudio', 'updateSeek'])
  }
};
</script>
